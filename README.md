...
| [Dyna-Q+]() ***(something wrong in DYNA-Q+, TO BE UPDATED WITH CHANGES SOON!)*** | **ShortcutMazeEnv** (*custom made env*): Reach the goal dodging obstacles | ***(something wrong in DYNA-Q+, TO BE UPDATED WITH CHANGES SOON!)*** ![maze0](images/shortcut_maze_after_Dyna-Q+_with_25_planning_steps.gif) | ![compare by steps](images/dyna_q_vs_dyna_qplus.png)                                         | 
| [Prioritized Sweeping]() | **ShortcutMazeEnv** (*custom made env*): Reach the goal dodging obstacles | ![maze0](images/shortcut_maze_prioritized_sweeping_maze_env.gif) ![maze](images/shortcut_maze_after_Dyna-Q_with_25_planning_steps.gif) | ![steps](images/prioritized_sweeping_maze_env_num_training_curves.png) ![sum rewards](images/prioritized_sweeping_maze_env_sum_rewards.png)                                        | 
