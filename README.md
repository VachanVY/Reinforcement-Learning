...
| 2017     | [Proximal Policy Optimization (PPO) -- Continuous Action Space](#)                         | BipedalWalker-v3: This environment is a continuous control locomotion task. According to optimal control theory, bang-bang control is suboptimal; smooth torque profiles are preferred for stability and energy efficiency.                 | ![opaos](images/PPO_Continuous_Actions_BipedalWalker-v3.gif)                 | ![Plot](images/PPO_Cont_Actions_BipedalWalker-v3_training_curves.png) |
