...
| Double Q-learning **(TODO)**           | **CliffWalking-v0**: Reach goal without falling  | ![CliffWalking](images/cliff_walking_double_qlearning.gif)  | ![Graph](images/cliff_walking_gamma0.99_alpha0.1_epsilon0.1.png) Doble Q-learning: Red |
| n-step Bootstrapping **(TODO)**        | -                                           | -                                             | -                                         |
| Planning and Learning with Tabular Methods **(TODO)** | -                                   | -                                             | -                                         |
